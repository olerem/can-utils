...
static int isobusfs_cli_fa_sf_res(struct isobusfs_priv *priv,
...
static int isobusfs_cli_fa_rf_res(struct isobusfs_priv *priv,
				  struct isobusfs_msg *msg)
{
...
static int isobusfs_cli_fa_cf_res(struct isobusfs_priv *priv,
				  struct isobusfs_msg *msg)
{
			  ...
			  struct isobusfs_msg *msg)
{
	...
	case ISOBUSFS_FA_F_CLOSE_FILE_RES:
		ret = isobusfs_cli_fa_cf_res(priv, msg);
		break;
	case ISOBUSFS_FA_F_READ_FILE_RES:
		ret = isobusfs_cli_fa_rf_res(priv, msg);
		break;
	case ISOBUSFS_FA_F_SEEK_FILE_RES:
		ret = isobusfs_cli_fa_sf_res(priv, msg);
		break;
